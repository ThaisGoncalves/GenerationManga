...
public class Usuario {
	...
	String[] listaBlackLagoon = new String[] { "Vol.1", "Vol.2", "Vol.3", "Vol.4", "Vol.5", "Vol.6", "Vol.7", "Vol.8",
			"Vol.9" };
	...
	int contBlack1 = 0, contBlack2 = 0, contBlack3 = 0, contBlack4 = 0, contBlack5 = 0, contBlack6 = 0, contBlack7 = 0,
			contBlack8 = 0, contBlack9 = 0;
	...
	int eAfro1 = 3, eAfro2 = 20;
	int eAkira1 = 2, eAkira2 = 4, eAkira3 = 5, eAkira4 = 6, eAkira5 = 8, eAkira6 = 10;
	int eBlack1 = 5, eBlack2 = 15, eBlack3 = 7, eBlack4 = 6, eBlack5 = 3, eBlack6 = 9, eBlack7 = 21, eBlack8 = 11,
			eBlack9 = 8;
	int eKill1 = 0, eKill2 = 2, eKill3 = 7;
	int eRed1 = 3, eRed2 = 8, eRed3 = 6, eRed4 = 7;
	...
	public void escolheTitulo() {
		...
		do {
			...
			case 1:
				...
				System.out.println(" Volume " + listaAfroSamurai[0] + " R$ " + precoAfro + " \tVolume "
						+ listaAfroSamurai[1] + " R$ " + precoAfro);
				int b = leia.nextInt();
				switch (b) {
				case 1:
					if (eAfro1 == 0) {
						System.out.println("Oop...este volume não está disponível no momento :(");
					} else {
						contAfro1++;
						eAfro1--;
						System.out.println("Você adicionou o volume 1 de Afro Samurai ao carrinho");
					}
					break;
				...
				case 2:
					if (eAfro2 == 0) {
						...
						contAfro2++;
						eAfro2--;
						System.out.println("Você adicionou o volume 2 de Afro Samurai ao carrinho");
					}
					break;
				...
				case 3:
					...
					break;
				default:
					System.out.println("erro case 1");
			...
			case 2:
				...
				System.out.println("\tVolumes disponíveis\n");
				System.out.println(" Volume " + listaAkira[0] + " R$" + precoAkira + " \tVolume " + listaAkira[1]
						+ " R$" + precoAkira + " \tVolume " + listaAkira[2] + " R$" + precoAkira + " \n\nVolume "
						+ listaAkira[3] + " R$" + precoAkira + " \tVolume " + listaAkira[4] + " R$" + precoAkira
						+ " \tVolume " + listaAkira[5] + " R$" + precoAkira);
				int c = leia.nextInt();
				switch (c) {
				case 1:
					if (eAkira1 == 0) {
						...
						System.out.println("Você adicionou o volume 1 de Akira ao carrinho");
						contAkira1++;
						eAkira1--;
					}
				...
				case 2:
					if (eAkira2 == 0) {
						...
						System.out.println("Você adicionou o volume 2 de Akira ao carrinho");
						contAkira2++;
						eAkira2--;
					}
				...
				case 3:
					if (eAkira3 == 0) {
						...
						System.out.println("Você adicionou o volume 3 de Akira ao carrinho");
						contAkira3++;
						eAkira3--;
					}
				...
				case 4:
					if (eAkira4 == 0) {
						...
						System.out.println("Você adicionou o volume 4 de Akira ao carrinho");
						contAkira4++;
						eAkira4--;
					}
				...
				case 5:
					if (eAkira5 == 0) {
						...
						System.out.println("Você adicionou o volume 5 de Akira ao carrinho");
						contAkira5++;
						eAkira5--;
					}
				...
				case 6:
					if (eAkira6 == 0) {
						...
						System.out.println("Você adicionou o volume 6 de Akira ao carrinho");
						contAkira6++;
						eAkira6--;
					}
				...
				case 7:
					...
					break;
				default:
					System.out.println("Oops! Algo deu errado...case 2");
				}
				break;
			...
			case 3:
				...
				System.out.println("\tVolumes disponíveis\n");
				System.out.println(" Volume " + listaBlackLagoon[0] + " R$" + precoBlack + " \tVolume "
						+ listaBlackLagoon[1] + " R$" + precoBlack + " \tVolume " + listaBlackLagoon[2] + " R$"
						+ precoBlack + " \tVolume " + listaBlackLagoon[3] + " R$" + precoBlack + " \tVolume "
						+ listaBlackLagoon[4] + " R$" + precoBlack + "\n\n Volume " + listaBlackLagoon[5] + " R$"
						+ precoBlack + " \tVolume " + listaBlackLagoon[6] + " R$" + precoBlack + " \tVolume "
						+ listaBlackLagoon[7] + " R$" + precoBlack + " \tVolume " + listaBlackLagoon[8] + " R$"
						+ precoBlack);
				int d = leia.nextInt();
				switch (d) {
				case 1:
					if (eBlack1 == 0) {
						...
						System.out.println("Você adicionou o volume 1 de Black Lagoon ao carrinho");
						contBlack1++;
						eBlack1--;
					}
				...
				case 2:
					if (eBlack2 == 0) {
						...
						System.out.println("Você adicionou o volume 2 de Black Lagoon ao carrinho");
						contBlack2++;
						eBlack2--;
					}
				...
				case 3:
					if (eBlack3 == 0) {
						...
						System.out.println("Você adicionou o volume 3 de Black Lagoon ao carrinho");
						contBlack3++;
						eBlack3--;
					}
				...
				case 4:
					if (eBlack4 == 0) {
						...
						System.out.println("Você adicionou o volume 4 de Black Lagoon ao carrinho");
						contBlack4++;
						eBlack4--;
					}
				...
				case 5:
					if (eBlack5 == 0) {
						...
						System.out.println("Você adicionou o volume 5 de Black Lagoon ao carrinho");
						contBlack5++;
						eBlack5--;
					}
				...
				case 6:
					if (eBlack6 == 0) {
						...
						System.out.println("Você adicionou o volume 6 de Black Lagoon ao carrinho");
						contBlack6++;
						eBlack6--;
					}
				...
				case 7:
					if (eBlack7 == 0) {
						...
						System.out.println("Você adicionou o volume 7 de Black Lagoon ao carrinho");
						contBlack7++;
						eBlack7--;
					}
				...
				case 8:
					if (eBlack8 == 0) {
						...
						System.out.println("Você adicionou o volume 8 de Black Lagoon ao carrinho");
						contBlack8++;
						eBlack8--;
					}
				...
				case 9:
					if (eBlack9 == 0) {
						...
						System.out.println("Você adicionou o volume 9 de Black Lagoon ao carrinho");
						contBlack9++;
						eBlack9--;
					}
				...
				case 10:
					...
					break;
				default:
					System.out.println("Oops! Algo deu errado...case 3");
				}
				break;
			...
			case 4:
				...
				System.out.println("\tVolumes disponíveis\n");
				System.out
						.println(" Volume " + listaKilllaKill[0] + " R$" + precoKill + " \tVolume " + listaKilllaKill[1]
								+ " R$" + precoKill + " \t\tVolume " + listaKilllaKill[2] + " R$" + precoKill);
				int e = leia.nextInt();
				switch (e) {
				case 1:
					if (eKill1 == 0) {
						...
						System.out.println("Você adicionou o volume 1 de Kill la Kill ao carrinho");
						contKill1++;
						eKill1--;
					}
				...
				case 2:
					if (eKill2 == 0) {
						...
						System.out.println("Você adicionou o volume 2 de Kill la Kill ao carrinho");
						contKill2++;
						eKill2--;
					}
				...
				case 3:
					if (eKill3 == 0) {
						...
						System.out.println("Você adicionou o volume 3 de Kill la Kill ao carrinho");
						contKill3++;
						eKill3--;
					}
				...
				case 4:
					...
					break;
				default:
					System.out.println("Oops! Algo deu errado...case 4");
				}
				break;
			...
			case 5:
				...
				System.out.println("\tVolumes disponíveis\n");
				System.out.println(" Volume " + listaRedGarden[0] + " R$" + precoRed + " \tVolume " + listaRedGarden[1]
						+ " R$" + precoRed + " \tVolume " + listaRedGarden[2] + " R$" + precoRed + " \tVolume "
						+ listaRedGarden[3] + " R$" + precoRed);
				int f = leia.nextInt();
				switch (f) {
				case 1:
					if (eRed1 == 0) {
						...
						System.out.println("Você adicionou o volume 1 de Red Garden ao carrinho");
						contRed1++;
						eRed1--;
					}
				...
				case 2:
					if (eRed2 == 0) {
						...
						System.out.println("Você adicionou o volume 2 de Red Garden ao carrinho");
						contRed2++;
						eRed2--;
					}
				...
				case 3:
					if (eRed3 == 0) {
						...
						System.out.println("Você adicionou o volume 3 de Red Garden ao carrinho");
						contRed3++;
						eRed3--;
					}
				...
				case 4:
					if (eRed4 == 0) {
						...
						System.out.println("Você adicionou o volume 4 de Red Garden ao carrinho");
						contRed4++;
						eRed4--;
					}
				...
				case 5:
					...
					break;
				default:
					System.out.println("Oops! Algo deu errado...case 5");
				}
				break;
	...
	public void credito1() {
		...
		System.out.println("O valor total a ser pago é de: R$" + Math.round(cred1) + " em 1 parcela");
	}
	...
	public void credito2() {
		...
		System.out.println("O valor total a ser pago é de: R$" + Math.round(cred2) + " em 2 parcelas de R$" + (Math.round(cred2) / 2));
	}
	...
	public void credito3() {
		...
		System.out.println("O valor total a ser pago é de: R$" + Math.round(cred3) + " em 3 parcelas de R$" + (Math.round(cred3) / 3));
	}
	...
	public void boleto() {
		...
		System.out.println("O valor total a ser pago é de: R$" + Math.round(bol));
	}

	public void finalizaCompra() {

		System.out.println("\n Você comprou " + somaContadores + " mangás e o valor total é R$" + Math.round(somaValor));
	...
	public void Carrinho() {
		...
		somaContadores = contAfro1 + contAfro2 + contAkira1 + contAkira2 + contAkira3 + contAkira4 + contAkira5
				...
				+ contBlack8 + contBlack9 + contKill1 + contKill2 + contKill3 + contRed1 + contRed2 + contRed3
				+ contRed4;
		...
		System.out.println("\n O valor total da sua compra é de: R$" + Math.round(somaValor));
					...
					if (a == 2) {
						...
						if (contAkira1 != 0) {
							...
							if (a == 2) {
								...
								if (contAkira2 != 0) {
									System.out.println("\n Deseja excluir" + listaTitulos[1] + " " + listaAkira[1]
											+ " do carrinho?");
									System.out.println("\n Sim --> (1) \t Não --> (2)");
									a = leia.nextInt();
									if (a == 1) {
										contAkira2--;
										System.out.println(
												listaTitulos[1] + " " + listaAkira[1] + " foi removido do carrinho");
										Carrinho();
									}
									if (a == 2) {

										if (contAkira3 != 0) {
											System.out.println("\n Deseja excluir" + listaTitulos[1] + " "
													+ listaAkira[2] + " do carrinho?");
											System.out.println("\n Sim --> (1) \t Não --> (2)");
											a = leia.nextInt();
											if (a == 1) {
												contAkira3--;
												System.out.println(listaTitulos[1] + " " + listaAkira[2]
											...
											if (a == 2) {
												...
												if (contAkira4 != 0) {
													System.out.println("\n Deseja excluir" + listaTitulos[1] + " "
															+ listaAkira[3] + " do carrinho?");
													System.out.println("\n Sim --> (1) \t Não --> (2)");
													a = leia.nextInt();
													if (a == 1) {
														contAkira4--;
														System.out.println(listaTitulos[1] + " " + listaAkira[3]
																+ " foi removido do carrinho");
														Carrinho();
													}
													if (a == 2) {
														...
														if (contAkira5 != 0) {
															System.out.println("\n Deseja excluir" + listaTitulos[1]
																	+ " " + listaAkira[4] + " do carrinho?");
															System.out.println("\n Sim --> (1) \t Não --> (2)");
															a = leia.nextInt();
															if (a == 1) {
																contAkira5--;
																System.out.println(listaTitulos[1] + " " + listaAkira[4]
																		+ " foi removido do carrinho");
																Carrinho();
															}
															if (a == 2) {
																...
																if (contAkira6 != 0) {
																	System.out.println(
																			"\n Deseja excluir" + listaTitulos[1] + " "
																					+ listaAkira[5] + " do carrinho?");
																	System.out.println("\n Sim --> (1) \t Não --> (2)");
																	a = leia.nextInt();
																	if (a == 1) {
																		contAkira6--;
																		System.out.println(
																				listaTitulos[1] + " " + listaAkira[5]
																						+ " foi removido do carrinho");
																		Carrinho();
																	}
																	if (a == 2) {
																		...
																		if (contBlack1 != 0) {
																			...
																			if (a == 1) {
																				contBlack1--;
																				System.out.println(listaTitulos[2] + " "
																						+ listaBlackLagoon[0]
																						+ " foi removido do carrinho");
																				Carrinho();
																			}
